...
class _irrigationState extends State<irrigation> {
  final irrigationref = FirebaseDatabase.instance.reference().child('Irrigation');
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       ...
       body:Container(color: Color.fromARGB(255, 226, 230, 232),child: FirebaseAnimatedList(
        query: irrigationref, shrinkWrap: true,itemBuilder: (context, snapshot, animation, index) {
          ...
          return GestureDetector(
            ...
            child:Column(children: [
              Container(height:  wid*0.6,width: wid*0.94,clipBehavior: Clip.antiAlias,decoration: BoxDecoration(borderRadius
                ...
                child:Image.asset('assets/images/f3.jpeg',fit: BoxFit.cover,)),// Image.network('${agro['practice']['image']}',fit: BoxFit.cover,),),
              SizedBox(height: 20,),
