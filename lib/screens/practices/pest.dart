...
class _pestState extends State<pest> {
  final Pestref = FirebaseDatabase.instance.reference().child('Pest Management');
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(title: Text('Pest Mangement') ,
       ...
       body:Container(color: Color.fromARGB(255, 226, 230, 232),child: FirebaseAnimatedList(
        query: Pestref, shrinkWrap: true,itemBuilder: (context, snapshot, animation, index) {
          ...
          return GestureDetector(
            ...
            child:Column(children: [
              Container(height:  wid*0.6,width: wid*0.94,clipBehavior: Clip.antiAlias,decoration: BoxDecoration(borderRadius
                ...
                child:Image.asset('assets/images/f2.jpeg',fit: BoxFit.cover,)),// Image.network('${agro['practice']['image']}',fit: BoxFit.cover,),),
              SizedBox(height: 20,),
